...
<form action="Registercontroller" method="POST"> <%-- sending form data to register controller--%>
 
<table align="center" cellpadding = "10">
<tr>
<td>First Name</td>    <%-- making field first name--%>
<td><input type="text" name="firstName" maxlength="30"/> <%--making input field --%>
